...
void showMessage(bool b, const QString &t){
 if (b) showMessage(QApplication::tr("True"),t);
 else showMessage(QApplication::tr("False"),t);
};

YesNoCancel yesNoCancel(const QString &ms, const QString &t){
 QString title("Qt application");
 QWidget *aw = qApp->activeWindow();
 if (t.size()) title = t;
 else if (aw) title = aw->windowTitle();
 ...
 else if (r==QMessageBox::No) return NO;
      else return CANCEL;
};

YesNoCancel yesNo(const QString &ms, const QString &t){
 QString title("Qt application");
 QWidget *aw = qApp->activeWindow();
 if (t.size()) title = t;
 else if (aw) title = aw->windowTitle();
...
void showStatus(const QString &ms){
 if (myStatusBar) myStatusBar->showMessage(ms);
};
