...
void showMessage(bool b, const QString &t=QString(""));

enum YesNoCancel {YES,NO,CANCEL};
YesNoCancel yesNoCancel(const QString &ms, const QString &t=QString(""));
YesNoCancel yesNo(const QString &ms, const QString &t=QString(""));
