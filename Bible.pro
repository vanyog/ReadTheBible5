...
# Input
HEADERS += mainWindow.h myFileRoutines.h showMessage.h bibleWindow.h exportDialog.h
...
SOURCES += main.cpp mainWindow.cpp myFileRoutines.cpp showMessage.cpp bibleWindow.cpp exportDialog.cpp
